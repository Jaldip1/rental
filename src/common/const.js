...
export const provinceData = {
    ...
    "Quebec": [
        "Asbestos", "Baie - Comeau", "Beloeil", "Cap - de - la - Madeleine", "Chambly", "Charlesbourg", "Ch�teauguay", "Chibougamau", "C�te - Saint - Luc", "Dorval",
        "Gasp�", "Gatineau", "Granby", "Havre - Saint - Pierre", "Hull", "Jonqui�re", "Kuujjuaq", "La Salle", "La Tuque", "Lachine", "Laval", "L�vis", "Longueuil", "Magog",
        "Matane", "Montreal", "Montr�al - Nord", "Perc�", "Port - Cartier", "Quebec", "Rimouski", "Rouyn - Noranda", "Saguenay", "Saint - Eustache", "Saint - Hubert",
        "Sainte - Anne - de - Beaupr�", "Sainte - Foy", "Sainte - Th�r�se", "Sept - �les", "Sherbrooke", "Sorel - Tracy", "Trois - Rivi�res", "Val - d�Or", "Waskaganish"
    ],
    "Saskatchewan": [
